    ...
    return (
        ...
        <main className={styles['main']}>
            ...
            <section className={styles['comment']}>
                <h3 className={styles['comment-title']}>ВАШИТЕ ОТЗИВИ СА ВАЖНИ ЗА НАС</h3>
 
                <div className={styles['comment-sec']}>
                    {comments.map(c => (
                        <div className={styles['comment-sec-product']}>
                            <h3 className={styles['comment-sec-title']}><span>име: </span>{c.username}</h3>
                            <div className={styles['img']}>
                                <img src={c.imageUrl} alt='meal' />
                            </div>
                            <p className={styles['comment-content']}>Коментар: {c.comment}</p>
