    ...
    return (
        ...
        <div className={styles['news-pictures']}>
            <div className={styles['news-pictures-child']}>
                <img className={styles['news-img1']} src="/images/fit_317_317 (2).jpg" alt="" />
                <div className={styles['news-desc']}>
                    <p> ПРЕЗ ФЕВРУАРИ </p>
                </div>
            </div>
            <div className={styles['news-pictures-child']}>
                <img className={styles['news-img2']} src="/images/fit_317_317 (1).jpg" alt="" />
                <div className={styles['news-desc']}>
                    <p> ПЕЧЕЛИВШИЯТ УЧАСТНИК В КОЛЕДА С ALADIN FOODS </p>
                </div>
            </div>
            <div className={styles['news-pictures-child']}>
                <img className={styles['news-img3']} src="/images/fit_317_317.jpg" alt="" />
                <div className={styles['news-desc']}>
